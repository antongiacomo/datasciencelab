...
<template>
  <article class="flex w-full items-center rounded-lg pb-4 antialiased">
    <nuxt-link class="h-full w-full" :to="article && article.path">
      <div
        class="flex h-full w-full flex-col justify-between rounded-xl border border-gray-200 bg-white px-6 py-3 pb-6 shadow-lg transition-colors hover:border hover:border-blue-900 hover:bg-blue-50/90 hover:shadow-xl"
      >
